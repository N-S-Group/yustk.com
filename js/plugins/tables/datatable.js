 ...
 * Created:     28/3/2008
 * Language:    Javascript       "bAutoWidth": false,
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			this.oLanguage = {
				...
				"sLengthMenu": "<span class='itemsPerPage'>На странице:</span> _MENU_",
				"sZeroRecords": "По вашему запросу ничего не найдено",
				"sEmptyTable": "В данном разделе нет данных",
				...
				"sInfoPostFix": "",
				"sInfoThousands": ",",
				"sSearch": "<span class='itemsPerPage'><a href='' style='color:red' id='delAllList' >Удалить выбранные</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Поиск:</span> ",
				"sUrl": "",
				"oPaginate": {
					"sFirst":    "Первая",
					"sPrevious": "Пред",
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			sSearchStr = (sSearchStr.indexOf('_INPUT_') !== -1) ?
			  ...
			  sSearchStr==="" ? '<input type="text" />' : sSearchStr+' <input type="text" style="" placeholder="строка поиска..." /><div class="srch"></div>';
